      ...
      <div className="container">
        <div className="text-right mb-6 m:hidden">
          <p className="uppercase text-[37px] font-thin leading-[1.2] tracking-[1.665px]">
            <span className="titleAccent">{hero.slogan[0]}</span>
            {hero.slogan[1]}
          </p>
        ...
        <div className="m:flex m:justify-between">
          <div>
            <h1 className="title mb-6 w-[280px] m:mb-[68px] m:w-[426px] l:w-[646px] l:mb-[148px]">
              <span className="titleAccent">{hero.titleAccent}</span>
              {hero.title}
            </h1>
          ...
          <div>
            ...
            <div className="cursor-pointer w-[280px] text-center bg-white/10 relative p-0.5 mx-auto hover:bg-white/20 focus:bg-white/20 trans m:w-[230px] m:bg-white/0.5 m:p-0 m:ml-auto m:mr-0 l:w-[293px] l:p-3">
              <Link
                to="contacts"
                spy={true}
                smooth={true}
