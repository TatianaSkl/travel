...
const Career: FC = () => {
  return (
    <section id="career" aria-labelledby="careerSectionTitle">
      <div className="section career-bg-m m:hidden">
        <div className="container">
          ...
          <p className="uppercase w-[181px] ml-auto text-[30px] font-extralight leading-[1.2] mb-9 pr-10">
            {career.question}
          </p>
          <ul className="w-[181px] text-right flex flex-col gap-4">
            {career.info.map(({ id, title, text }) => (
              <li key={id}>
                <p className="leading-[20px] mb-2">{title}</p>
                <p className="text-[12px] font-extralight leading-[20px]">{text}</p>
              </li>
            ))}
          </ul>
        </div>
      </div>
      <div className="section career-bg-m m:career-bg-t l:career-bg-d">
        <div className="container">
          ...
          <div className="md:hidden l:flex l:gap-[333px]">
          ...
          <div className="m:flex m:gap-5 l:gap-6">
            <ul className="md:hidden w-[181px] text-right flex flex-col gap-4 m:w-[221px] m:gap-6 l:w-[602px]">
              {career.info.map(({ id, title, text }) => (
            ...
            <div>
              <div className="w-[179px] mb-6 ml-auto font-extralight leading-[20px] m:w-[170px] m:ml-0 m:text-[13px] m:font-extralight m:leading-[20px] m:mb-8 l:hidden">
                <p>{career.text[0]}</p>
                <p>{career.text[1]}</p>
              </div>
              <FormCareer />
